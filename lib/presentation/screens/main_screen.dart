    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          // Modelo Auditivo — simulación del sistema auditivo humano (4 etapas)
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (effectiveEnabled) ...[
              const SizedBox(height: 8),
              // ─── Selector de motor de denoising (3 motores) ──────────
