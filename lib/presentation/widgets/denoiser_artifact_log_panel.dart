...
class _DenoiserArtifactLogPanelState extends State<DenoiserArtifactLogPanel> {
  ...
  Future<void> _copy() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(ok
            ? 'Registro de calidad copiado al portapapeles'
      ...
      child: Column(
        ...
        children: [
          ...
          if (_summary.isEmpty)
            ...
            _stageRow('1· RNNoise (Estándar)', 'sys0', highlight: activeEngine == 0),
            _stageRow('2· DPDFNet-4 (Ultra)', 'sys3', highlight: activeEngine == 3),
