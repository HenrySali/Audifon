...
class _DenoiserToggleState extends State<DenoiserToggle> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Solo se ofrecen Estándar (RNNoise), Ultra (DPDFNet) e Inteligente (DTLN).
        // Premium (DFN3) y Analítico (GTCRN) fueron retirados.
        ...const [DenoiserType.rnnoise, DenoiserType.dpdfnet, DenoiserType.dtln]
  ...
  String _label(DenoiserType t) => switch (t) {
        ...
        DenoiserType.dtln => 'Inteligente (DTLN)',
      };
  ...
  String _subtitle(DenoiserType t) => switch (t) {
        ...
        DenoiserType.dtln => 'Baja latencia, phase-aware, sin artefactos',
      };
}
